...
keymap("n", "[sub]r", ":FzfLua registers<CR>",  { silent = true })
keymap("n", "[sub]d", ":FzfLua diagnostics_document<CR>",  { silent = true })
keymap("n", "[sub]o", ":FzfLua lsp_document_symbols<CR>",  { silent = true })
keymap("n", "[sub]t", ":FzfLua lsp_workspace_symbols<CR>",  { silent = true })
...
keymap("n", "<C-\\>", ":FzfLua lsp_references ignore_current_line=true includeDeclaration=false<CR>", { silent = true })
