...
keymap("n", "[sub]s", ":CocList sessions<CR>",  { silent = true })
...
keymap("n", "[git]a", ":GitGutterStageHunk<CR>",  { silent = true })
...
keymap("n", "[d", "GitGutterPrevHunk<CR>",  { silent = true })
keymap("n", "]d", "GitGutterNextHunk<CR>",  { silent = true })
-- Misc
...
keymap("n", "g<C-a>", "<Plug>(trip-increment-ignore-minus)", { remap = true, silent = true })
keymap("n", "g<C-x>", "<Plug>(trip-decrement-ignore-minus)", { remap = true, silent = true })
