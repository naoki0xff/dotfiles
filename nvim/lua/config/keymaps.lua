...
vim.keymap.set("n", "[sub]a", "<cmd>FzfLua git_hunks<CR>",  { silent = true })
...
vim.keymap.set("n", "[sub]:", "<cmd>FzfLua command_history<CR>",  { silent = true })
vim.keymap.set("n", "[sub]/", "<cmd>FzfLua search_history<CR>",  { silent = true })
vim.keymap.set("n", "<Space>c", "<cmd>FzfLua commands<CR>",  { silent = true })
vim.keymap.set("n", "[sub]h", "<cmd>FzfLua helptags<CR>",  { silent = true })
vim.keymap.set("n", "[sub]k", "<cmd>FzfLua keymaps<CR>",  { silent = true })
-- LSP
...
vim.keymap.set("n", "[git]d", "<cmd>Gitsigns diffthis<CR>", { silent = true })
...
vim.keymap.set("n", "[git]p", "<cmd>Gitsigns preview_hunk<CR>",  { silent = true })
vim.keymap.set("n", "<Leader>a", "<cmd>Gitsigns stage_hunk<CR>", { silent = true })
vim.keymap.set("n", "<Leader>u", "<cmd>Gitsigns stage_hunk<CR>", { silent = true })
vim.keymap.set("v", "<Leader>a", "<cmd>Gitsigns stage_hunk<CR>", { silent = true })
...
vim.keymap.set("n", "<Space>n", "<cmd>Neotree position=left action=focus toggle=true reveal_force_cwd=true<CR>",  { silent = true })
vim.keymap.set("n", "<Space>v", "<cmd>Outline<CR>",  { silent = true })
...
vim.keymap.set("n", "<Leader>s", "<cmd>Persisted select<CR>", { silent = true })
vim.keymap.set("n", "<Leader>q", "<cmd>Persisted delete_current<CR>", { silent = true })
